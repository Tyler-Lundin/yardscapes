...
function MiniNav({ isScrolled, setIsMenuOpen }: NavProps) {
  return (
    <div className={`fixed top-0 left-0 right-0 z-[200] bg-gradient-to-r from-blue-300/50 dark:from-blue-950/75 via-yellow-400/50 dark:via-yellow-950/75 to-blue-400/50 dark:to-blue-950/75 backdrop-blur-md shadow-md transition-all duration-300 ${
