      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 bg-white p-6 rounded-lg shadow-xl scale-50 md:scale-100">
              <div className="text-4xl font-serif font-bold text-emerald-600">{OWNER.yearsExperience}+</div>
